# -*- coding: utf-8 -*-
"""
Created on Wed Jul 17 15:17:43 2019
...
class Scrappo:
    ...
    def checkGUI(self, driver):
        try:
            driver.find_element_by_xpath("//*[@id='app']/div[3]/div[1]/div/main/div[2]/div/div[2]/div[2]/div[2]/div[1]/div/div[1]/a")
    ...
    def getUserInput(self):
         ...
         return [userReports, noOfMatches, username]
    ...
    def scrape(self, userInput):
        ...
        time.sleep(1.5)
        driver.find_element_by_xpath("/html/body/div[2]/div[1]/div/div/div[2]/a[2]").click() #cookies message
        
        dfMatchData = Scrape.createDF()
        scrapedMatches = 0
        noOfMatchesFound = 0
        while scrapedMatches < noOfMatches:
            noOfMatchesFound = noOfMatchesFound + Scrape.selectNextFSMatch(driver, userName, noOfMatchesFound, linktooverview)
    ...
    def selectNextFSMatch(self, driver, userName, noOfMatchesFound, linktooverview):
        ...
        while i<= suchRadius:
            matchPath =                              "//*[@id='app']/div[3]/div[1]/div/main/div[2]/div/div[2]/div[2]/div[2]/div[1]/div/div[" + str(i) + "]/a"
            matchtype = driver.find_element_by_xpath("//*[@id='app']/div[3]/div[1]/div/main/div[2]/div/div[2]/div[2]/div[2]/div[1]/div/div[" + str(i) + "]/div/div[1]/span[1]").text
                                                      
            if matchtype.startswith("Firestorm Squads"):
                matchNo= matchNo+1
                if matchNo > noOfMatchesFound:
                    driver.find_element_by_xpath(matchPath).click() #click on report
                    time.sleep(2.5)
                    return 1 
                else: 
                ...
                print("kein FSmatch an Stelle " + str(i) )
                i = i+1
